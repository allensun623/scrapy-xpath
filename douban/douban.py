...
def input_xpath():
    ...
    xpath_dic = {
        ...
        "page_xpath": "//div[@class='paginator']/span[@class='next']/a/@href",
        "items_rank_xpath": "/div[@class='item']/div[@class='pic']/em/text()",
        "items_title_xpath": "/div[@class='item']/div[@class='info']/div[@class='hd']/a/span[@class='title']/text()",
        "items_stars_xpath": "/div[@class='item']/div[@class='info']/div[@class='bd']/p[1]/text()",
        "items_score_xpath": "/div[@class='item']/div[@class='info']/div[@class='bd']/div[@class='star']/span[@class='rating_num']/text()",    
        "items_quote_xpath": "/div[@class='item']/div[@class='info']/div[@class='bd']/p[@class='quote']/span[@class='inq']/text()"    
    }
